...
object 线性回归模型 extends loadData{
  def main(args: Array[String]): Unit = {
    ...
    println("线性回归R2", 1-evaluator.evaluate(data3_result))
  }
}
...
object 支持向量机模型 extends loadData{
  def main(args: Array[String]): Unit = {
    ...
    val evaluator = new BinaryClassificationEvaluator()
      .setLabelCol("好瓜2")
      .setRawPredictionCol("rawPrediction")
    println("准确率", evaluator.evaluate(data3_result))
  }
}

object 朴素贝叶斯模型 extends loadData{
  def main(args: Array[String]): Unit = {
